...
const gameParams = {
  priceUrl:
    "https://uppsi22mf2.execute-api.us-east-1.amazonaws.com/Prod/price/",
  SEC: 1000,
  endowment: 0,
  awards: {
    nums: {
      ...
      3: {
        ...
        desc:
          "You are getting the hang of it: 3 transactions and a Silver Award.",
      },
      5: {
        img:
      ...
      10: {
        img:
          "https://cdn4.iconfinder.com/data/icons/emoji-66/64/34-rich-256.png",
        name: "platinum",
        brief: "Wolf of Wall Street: 10 transactions!",
        desc:
          "A true Wolf of Wall Street: 10 transactions in the round. Well-earned PLATINUM award!",
      },

      20: {
        img:
          "https://cdn3.iconfinder.com/data/icons/start-up-4/44/money_bag-512.png",
        name: "diamond",
        brief: "Hall of Fame Trader: 20 trades!",
        desc:
          "Hall of Fame Trader: 20 trades and the DIAMOND award, this is the peak!",
      },
    },
  },
  ...window.gameParams,
};
export const innerGamified = (day_number) => {
         const res = _.find(
           window.gameParams.day_params,
           _.matches({ round: day_number })
         );
         if (res) {
           return res.gamified;
         } else return false;
